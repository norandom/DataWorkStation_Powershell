...
Describe 'Quantitative research environment contracts' {
    It '<Section> passes' -ForEach @(
        ...
        @{ Section = 'PositronDeclaration' }, @{ Section = 'PositronStatus' },
        @{ Section = 'PositronLicenseBoundary' }, @{ Section = 'QuartoDeclaration' },
        @{ Section = 'QuartoStatus' }, @{ Section = 'QuartoToolchainBoundary' },
